...
using std::variant, std::cout, std::string, std::set, std::complex, std::vector;
auto variants() noexcept -> void;
auto variant_class_derived() noexcept;
auto variants() noexcept -> void
{
    ...
    auto variant_empty_state() noexcept
    {
    ...
    template <typename... args>
    make_visitor(args...) -> make_visitor<args...>;
