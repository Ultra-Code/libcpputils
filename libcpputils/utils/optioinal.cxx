...
auto optional_bool_ptr()
{
    ...
    {
        std::cout << "func implicit convert to boolean .NB:same as above " << *boolean
                  << '\n';
    }
    ...
    if constexpr (!(*boolean))
    {
        std::cout << "implicit convert boolean to value and invert .NB:same as above "
                  << *boolean << '\n';
    }
}
auto nested_optionals()
{
