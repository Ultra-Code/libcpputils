...
namespace mal
{
    ...
    template <typename T>
    auto Array<T>::operator[](size_t index) -> T&
    {
    ...
    template <typename T>
    auto Array<T>::operator[](size_t index) const -> const T&
    {
        if (index >= m_size)
        {
    ...
    template <typename T>
    auto Array<T>::operator=(const Array<T>& rhsCopy) -> Array<T>&
    {
    ...
    template <typename T>
    auto Array<T>::operator=(Array&& rhsMove) noexcept -> Array<T>&
    {
    ...
    template <typename T>
    auto Array<T>::swap(Array& rhs) noexcept -> void
    {
        using std::swap;
